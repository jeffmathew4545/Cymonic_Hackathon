...
# Risk categories
RISK_THRESHOLD_HIGH = 0.7   # Score >= 0.7 means high/critical risk of remaining vacant
RISK_THRESHOLD_MEDIUM = 0.4 # Score >= 0.4 means medium risk

# Margin constraints
MIN_REQUIRED_MARGIN_AFTER_DISCOUNT = 10.0 # Minimum % margin retained after discount
